/*!
 * 
 * Super simple WYSIWYG usuario v0.8.20
...
var History = /*#__PURE__*/function () {
  ...
  History_createClass(History, [{
    ...
    */
    ...
    /**
    *  @method commit
    *  Resets history stack, but keeps current usuario's content.
    */
    ...
    /**
    * @method reset
    * Resets the history stack completely; reverting to an empty usuario.
    */
    ...
    value: function pasteByEvent(event) {
      ...
      if (clipboardData && clipboardData.items && clipboardData.items.length) {
        ...
        if (item.kind === 'file' && item.type.indexOf('image/') !== -1) {
          // paste img file
          this.context.invoke('usuario.insertImagesOrCallback', [item.getAsFile()]);
          event.preventDefault();
        } else if (item.kind === 'string') {
          // paste text with maxTextLength check
          if (this.context.invoke('usuario.isLimited', clipboardData.getData('Text').length)) {
            event.preventDefault();
          }
        }
        ...
        if (this.context.invoke('usuario.isLimited', text.length)) {
          event.preventDefault();
        }
      } // Call usuario.afterCommand after proceeding default event handler


      setTimeout(function () {
        _this.context.invoke('usuario.afterCommand');
      }, 10);
    }
  }]);
...
var Dropzone = /*#__PURE__*/function () {
  ...
  Dropzone_createClass(Dropzone, [{
    ...
    value: function attachDragAndDropEvent() {
      ...
      // -but only if the usuario is visible, i.e. has a positive width and height
      ...
      this.$dropzone.on('drop', function (event) {
        ...
        if (dataTransfer && dataTransfer.files && dataTransfer.files.length) {
          ...
          _this.context.invoke('usuario.insertImagesOrCallback', dataTransfer.files);
        } else {
          external_jQuery_default().each(dataTransfer.types, function (idx, type) {
            ...
            if (type.toLowerCase().indexOf('text') > -1) {
              _this.context.invoke('usuario.pasteHTML', content);
            } else {
              external_jQuery_default()(content).each(function (idx, item) {
                _this.context.invoke('usuario.insertNode', item);
              });
            }
          });
        }
  ...
  Handle_createClass(Handle, [{
    ...
    value: function initialize() {
      ...
      this.$handle.on('mousedown', function (event) {
        if (dom.isControlSizing(event.target)) {
          ...
          var onMouseMove = function onMouseMove(event) {
            _this2.context.invoke('usuario.resizeTo', {
          ...
          _this2.$document.on('mousemove', onMouseMove).one('mouseup', function (e) {
            ...
            _this2.context.invoke('usuario.afterCommand');
          });
    ...
    value: function update(target, event) {
      ...
      if (isImage) {
        ...
        this.context.invoke('usuario.saveTarget', target);
      } else {
        this.hide();
      }
    ...
    key: "hide",
    value: function hide() {
      this.context.invoke('usuario.clearTarget');
  ...
  AutoLink_createClass(AutoLink, [{
    ...
    value: function replace() {
      ...
      if (match && (match[1] || match[2])) {
        ...
        this.lastWordRange = null;
        this.context.invoke('usuario.focus');
      }
    }
  }, {
    key: "handleKeydown",
    value: function handleKeydown(e) {
      if (lists.contains([key.code.ENTER, key.code.SPACE], e.keyCode)) {
        var wordRange = this.context.invoke('usuario.createRange').getWordRange();
    ...
    value: function replace() {
      ...
      this.options.match(keyword, function (match) {
        if (match) {
          ...
          self.lastWord = null;
          self.context.invoke('usuario.focus');
        }
      });
    }
  }, {
...
var Placeholder = /*#__PURE__*/function () {
  ...
  Placeholder_createClass(Placeholder, [{
    ...
    value: function update() {
      var isShow = !this.context.invoke('codeview.isActivated') && this.context.invoke('usuario.isEmpty');
...
var Buttons = /*#__PURE__*/function () {
  ...
  Buttons_createClass(Buttons, [{
        ...
        children: [this.button({
          ...
          click: function click(e) {
            ...
            if (backColor && foreColor) {
              _this.context.invoke('usuario.color', {
          ...
          click: function click(event) {
            ...
            if (eventName === 'openPalette') {
              ...
              _this.context.invoke('usuario.' + eventName, value);
            }
          }
        })]
      }).render();
    ...
    value: function addToolbarButtons() {
      ...
      this.context.memo('button.style', function () {
        return _this2.ui.buttonGroup([_this2.button({
          ...
          click: _this2.context.createInvokeHandler('usuario.formatBlock')
        })]).render();
      });
      ...
      this.context.memo('button.bold', function () {
        return _this2.button({
          ...
          click: _this2.context.createInvokeHandlerAndUpdateState('usuario.bold')
        }).render();
      });
      this.context.memo('button.italic', function () {
        return _this2.button({
          ...
          click: _this2.context.createInvokeHandlerAndUpdateState('usuario.italic')
        }).render();
      });
      this.context.memo('button.underline', function () {
        return _this2.button({
          ...
          click: _this2.context.createInvokeHandlerAndUpdateState('usuario.underline')
        }).render();
      });
      this.context.memo('button.clear', function () {
        return _this2.button({
          ...
          click: _this2.context.createInvokeHandler('usuario.removeFormat')
        }).render();
      });
      this.context.memo('button.strikethrough', function () {
        return _this2.button({
          ...
          click: _this2.context.createInvokeHandlerAndUpdateState('usuario.strikethrough')
        }).render();
      });
      this.context.memo('button.superscript', function () {
        return _this2.button({
          ...
          click: _this2.context.createInvokeHandlerAndUpdateState('usuario.superscript')
        }).render();
      });
      this.context.memo('button.subscript', function () {
        return _this2.button({
          ...
          click: _this2.context.createInvokeHandlerAndUpdateState('usuario.subscript')
        }).render();
      });
      this.context.memo('button.fontname', function () {
        var styleInfo = _this2.context.invoke('usuario.currentStyle');
        ...
        return _this2.ui.buttonGroup([_this2.button({
          ...
          click: _this2.context.createInvokeHandlerAndUpdateState('usuario.fontName')
        })]).render();
      });
      this.context.memo('button.fontsize', function () {
        return _this2.ui.buttonGroup([_this2.button({
          ...
          click: _this2.context.createInvokeHandlerAndUpdateState('usuario.fontSize')
        })]).render();
      });
      this.context.memo('button.fontsizeunit', function () {
        return _this2.ui.buttonGroup([_this2.button({
          ...
          click: _this2.context.createInvokeHandlerAndUpdateState('usuario.fontSizeUnit')
        })]).render();
      });
      ...
      this.context.memo('button.ul', function () {
        return _this2.button({
          ...
          click: _this2.context.createInvokeHandler('usuario.insertUnorderedList')
        }).render();
      });
      this.context.memo('button.ol', function () {
        return _this2.button({
          ...
          click: _this2.context.createInvokeHandler('usuario.insertOrderedList')
        }).render();
      });
      var justifyLeft = this.button({
        contents: this.ui.icon(this.options.icons.alignLeft),
        tooltip: this.lang.paragraph.left + this.representShortcut('justifyLeft'),
        click: this.context.createInvokeHandler('usuario.justifyLeft')
      });
      var justifyCenter = this.button({
        contents: this.ui.icon(this.options.icons.alignCenter),
        tooltip: this.lang.paragraph.center + this.representShortcut('justifyCenter'),
        click: this.context.createInvokeHandler('usuario.justifyCenter')
      });
      var justifyRight = this.button({
        contents: this.ui.icon(this.options.icons.alignRight),
        tooltip: this.lang.paragraph.right + this.representShortcut('justifyRight'),
        click: this.context.createInvokeHandler('usuario.justifyRight')
      });
      var justifyFull = this.button({
        contents: this.ui.icon(this.options.icons.alignJustify),
        tooltip: this.lang.paragraph.justify + this.representShortcut('justifyFull'),
        click: this.context.createInvokeHandler('usuario.justifyFull')
      });
      var outdent = this.button({
        contents: this.ui.icon(this.options.icons.outdent),
        tooltip: this.lang.paragraph.outdent + this.representShortcut('outdent'),
        click: this.context.createInvokeHandler('usuario.outdent')
      });
      var indent = this.button({
        contents: this.ui.icon(this.options.icons.indent),
        tooltip: this.lang.paragraph.indent + this.representShortcut('indent'),
        click: this.context.createInvokeHandler('usuario.indent')
      });
      ...
      this.context.memo('button.height', function () {
        return _this2.ui.buttonGroup([_this2.button({
          ...
          click: _this2.context.createInvokeHandler('usuario.lineHeight')
        })]).render();
      });
      this.context.memo('button.table', function () {
        return _this2.ui.buttonGroup([_this2.button({
          ...
          callback: function callback($node) {
            ...
            }).mouseup(_this2.context.createInvokeHandler('usuario.insertTable')).on('mousemove', _this2.tableMoveHandler.bind(_this2));
          }
        }).render();
      });
      ...
      this.context.memo('button.hr', function () {
        return _this2.button({
          ...
          click: _this2.context.createInvokeHandler('usuario.insertHorizontalRule')
        }).render();
      });
      ...
      this.context.memo('button.redo', function () {
        return _this2.button({
          ...
          click: _this2.context.createInvokeHandler('usuario.redo')
        }).render();
      });
      this.context.memo('button.undo', function () {
        return _this2.button({
          ...
          click: _this2.context.createInvokeHandler('usuario.undo')
        }).render();
      });
    ...
    value: function addImagePopoverButtons() {
      ...
      this.context.memo('button.resizeFull', function () {
        return _this3.button({
          ...
          click: _this3.context.createInvokeHandler('usuario.resize', '1')
        }).render();
      });
      this.context.memo('button.resizeHalf', function () {
        return _this3.button({
          ...
          click: _this3.context.createInvokeHandler('usuario.resize', '0.5')
        }).render();
      });
      this.context.memo('button.resizeQuarter', function () {
        return _this3.button({
          ...
          click: _this3.context.createInvokeHandler('usuario.resize', '0.25')
        }).render();
      });
      this.context.memo('button.resizeNone', function () {
        return _this3.button({
          ...
          click: _this3.context.createInvokeHandler('usuario.resize', '0')
        }).render();
      }); // Float Buttons
      ...
      this.context.memo('button.floatLeft', function () {
        return _this3.button({
          ...
          click: _this3.context.createInvokeHandler('usuario.floatMe', 'left')
        }).render();
      });
      this.context.memo('button.floatRight', function () {
        return _this3.button({
          ...
          click: _this3.context.createInvokeHandler('usuario.floatMe', 'right')
        }).render();
      });
      this.context.memo('button.floatNone', function () {
        return _this3.button({
          ...
          click: _this3.context.createInvokeHandler('usuario.floatMe', 'none')
        }).render();
      }); // Remove Buttons
      ...
      this.context.memo('button.removeMedia', function () {
        return _this3.button({
          ...
          click: _this3.context.createInvokeHandler('usuario.removeMedia')
        }).render();
      });
    }
  }, {
    ...
    value: function addLinkPopoverButtons() {
      ...
      this.context.memo('button.unlink', function () {
        return _this4.button({
          ...
          click: _this4.context.createInvokeHandler('usuario.unlink')
        }).render();
      });
    }
    /**
    ...
    value: function addTablePopoverButtons() {
      ...
      this.context.memo('button.addRowUp', function () {
        return _this5.button({
          ...
          click: _this5.context.createInvokeHandler('usuario.addRow', 'top')
        }).render();
      });
      this.context.memo('button.addRowDown', function () {
        return _this5.button({
          ...
          click: _this5.context.createInvokeHandler('usuario.addRow', 'bottom')
        }).render();
      });
      this.context.memo('button.addColLeft', function () {
        return _this5.button({
          ...
          click: _this5.context.createInvokeHandler('usuario.addCol', 'left')
        }).render();
      });
      this.context.memo('button.addColRight', function () {
        return _this5.button({
          ...
          click: _this5.context.createInvokeHandler('usuario.addCol', 'right')
        }).render();
      });
      this.context.memo('button.deleteRow', function () {
        return _this5.button({
          ...
          click: _this5.context.createInvokeHandler('usuario.deleteRow')
        }).render();
      });
      this.context.memo('button.deleteCol', function () {
        return _this5.button({
          ...
          click: _this5.context.createInvokeHandler('usuario.deleteCol')
        }).render();
      });
      this.context.memo('button.deleteTable', function () {
        return _this5.button({
          ...
          click: _this5.context.createInvokeHandler('usuario.deleteTable')
        }).render();
      });
    }
  }, {
    ...
    value: function updateCurrentStyle($container) {
      ...
      var styleInfo = this.context.invoke('usuario.currentStyle');
...
var LinkDialog = /*#__PURE__*/function () {
  ...
  LinkDialog_createClass(LinkDialog, [{
    ...
    value: function show() {
      ...
      var linkInfo = this.context.invoke('usuario.getLinkInfo');
      this.context.invoke('usuario.saveRange');
      this.showLinkDialog(linkInfo).then(function (linkInfo) {
        _this2.context.invoke('usuario.restoreRange');

        _this2.context.invoke('usuario.createLink', linkInfo);
      }).fail(function () {
        _this2.context.invoke('usuario.restoreRange');
      });
    }
...
var LinkPopover = /*#__PURE__*/function () {
  ...
  LinkPopover_createClass(LinkPopover, [{
    ...
    value: function update() {
      ...
      if (!this.context.invoke('usuario.hasFocus')) {
        this.hide();
        return;
      }

      var rng = this.context.invoke('usuario.getLastRange');
  ...
  ImageDialog_createClass(ImageDialog, [{
    ...
    value: function show() {
      ...
      this.showImageDialog().then(function (data) {
        ...
        _this.context.invoke('usuario.restoreRange');
        ...
        if (typeof data === 'string') {
          ...
          if (_this.options.callbacks.onImageLinkInsert) {
            ...
            _this.context.invoke('usuario.insertImage', data);
          }
        } else {
          // array of files
          _this.context.invoke('usuario.insertImagesOrCallback', data);
        }
      }).fail(function () {
        _this.context.invoke('usuario.restoreRange');
      });
...
var TablePopover = /*#__PURE__*/function () {
  ...
  TablePopover_createClass(TablePopover, [{
    ...
    value: function initialize() {
      ...
      var $content = this.$popover.find('.popover-content,.note-popover-content');
      this.context.invoke('buttons.build', $content, this.options.popover.table); // [workaround] Disable Firefox's default table usuario
...
var VideoDialog = /*#__PURE__*/function () {
  ...
  VideoDialog_createClass(VideoDialog, [{
    ...
    value: function show() {
      ...
      var text = this.context.invoke('usuario.getSelectedText');
      this.context.invoke('usuario.saveRange');
      this.showVideoDialog(text).then(function (url) {
        // [workaround] hide dialog before restore range for IE range focus
        _this.ui.hideDialog(_this.$dialog);

        _this.context.invoke('usuario.restoreRange'); // build node
        ...
        if ($node) {
          // insert video node
          _this.context.invoke('usuario.insertNode', $node);
        }
      }).fail(function () {
        _this.context.invoke('usuario.restoreRange');
      });
  ...
  HelpDialog_createClass(HelpDialog, [{
    ...
    value: function show() {
      ...
      this.showHelpDialog().then(function () {
        _this3.context.invoke('usuario.restoreRange');
      });
    }
  }]);
  ...
  HintPopover_createClass(HintPopover, [{
    ...
    value: function handleKeyup(e) {
      ...
      if (!lists.contains([key.code.ENTER, key.code.UP, key.code.DOWN], e.keyCode)) {
        var _range = this.context.invoke('usuario.getLastRange');
...
var editor = renderer.create('<div class="note-usuario note-frame panel panel-default"></div>');
...
var airEditor = renderer.create('<div class="note-usuario note-airframe"></div>');
