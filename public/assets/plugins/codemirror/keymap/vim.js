 ...
 *
 * Events:
 *  'vim-mode-change' - raised on the usuario anytime the current mode changes,
...
(function(mod) {
  ...
  var Vim = function() {
    ...
    * in the right place.
     ...
     *
     * - usuario mode should be htmlmixedmode / xml
    ...
    ExCommandDispatcher.prototype = {
      ...
      _processCommand: function(cm, input, opt_params) {
        ...
        if (!commandName) {
          showConfirm(cm, 'Not an usuario command ":' + input + '"');
          return;
        }
        try {
