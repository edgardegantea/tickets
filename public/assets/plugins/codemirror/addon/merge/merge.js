...
(function(mod) {
  ...
  function syncScroll(dv, toOrig) {
    ...
    // Don't take action if the position of this usuario was recently set
  ...
  // Updating the marks for usuario content
  ...
  // Updating the gap between usuario and original
  ...
  // an array of lines, in a single usuario, that probably need to be
  // aligned with their counterparts in the usuario next to it.
  ...
  var MergeView = CodeMirror.MergeView = function(node, options) {
    ...
    var editPane = elt("div", null, "CodeMirror-merge-pane CodeMirror-merge-usuario");
    wrap.push(editPane);
