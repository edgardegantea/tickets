...
class TicketController extends ResourceController
{
    ...
    public function index()
    {
        ...
        $builder3->orderBy('created_at', 'desc');
    ...
    public function lista()
    {
        ...
        $data = [
            ...
            'total' => $total,
            'status' => $status,
            'tickets2' => $tickets2->orderBy('created_at', 'asc')->findAll(),
            'usuario' => $usuario,
            'tickets' => $tickets,
        ];
    ...
    public function cerrar_ticket($id)
    {
        ...
        if ($ticket) {
            $this->ticket->update($id, ['status' => 's08']);
            return redirect()->to('admin/tickets')->with('success', 'Ticket cerrado con éxito.');
        } else {
            return redirect()->to('admin/tickets')->with('error', 'Error al cerrar el ticket.');
        }
    }
