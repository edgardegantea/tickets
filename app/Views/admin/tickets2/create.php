...
<div class="card card-primary">
    ...
    <form action="/admin/tickets2" method="post" enctype="multipart/form-data">
    ...
    <div class="card-body">
        ...
        <div class="row">
            <div class="form-group col-12">
                ...
                <input class="form-control <?php if ($validation->getError('title')): ?>is-invalid<?php endif; ?>" required type="text" name="title"
                       style="font-size: x-large;" value="<?php echo set_value('title'); ?>">
        ...
        <div class="row">
            <div class="form-group col">
                <label for="" class="label">Adjuntar archivo:</label>
                <input  class="" type="file" id="formFile" name="evidence"  accept="application/msword, application/vnd.ms-excel, application/vnd.ms-powerpoint, text/plain, application/pdf, image/*, .zip, .rar, .7zip">
            </div>
        </div>
