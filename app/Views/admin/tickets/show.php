    ...
    <div class="col-md-8">
        ...
        <div class="card">
            <div class="card-header bg-dark">
                ...
                <?php if ($ticket['status'] != 's08'): ?>
                    <a href="<?= base_url('/admin/tickets/cerrar_ticket/' . $ticket['id']) ?>" class="btn btn-info btn-sm float-right mr-2">Cerrar ticket</a>
                <?php else: ?>
                    <button disabled class="btn btn-info btn-sm float-right mr-2">Ticket cerrado</button>
                <?php endif; ?>

                <form class="display-none" method="post"
                      action="<?= base_url('/admin/tickets/' . $ticket['id']) ?>"
