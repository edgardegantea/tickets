    ...
    <div class="card card-secondary">
        ...
        <div class="card-body">
            ...
            <div class="row">
                <div class="form-group">
                    <label for="exampleInputBorderWidth2">Imagen de perfil:</label>
                    <br>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input disabled type="text" class="form-control form-control-border border-width-2"
                               ...
                               value="<?php echo trim($usuario['apaterno']); ?>">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input disabled type="text" class="form-control form-control-border border-width-2"
                               ...
                               value="<?php echo trim($usuario['amaterno']); ?>">
                    </div>
                </div>
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input disabled type="email" class="form-control form-control-border border-width-2"
                               ...
                               value="<?php echo trim($usuario['email']); ?>">
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                ...
                <div class="form-group">
                    ...
                    <input disabled name="phone_no" type="tel" class="form-control form-control-border border-width-2"
                           value="<?php echo trim($usuario['phone_no']); ?>">
                </div>
            </div>
        ...
        <div class="card-footer">
            <a href="<?= base_url('/admin/usuarios/' . $usuario['id'] . '/edit') ?>"
               class="btn btn-primary float-right">Editar</a>
            <a href="<?php echo base_url('admin/usuarios/edit_password/' . $usuario['id']); ?>"
               class="btn btn-danger float-right mr-3">Cambiar contraseña</a>
