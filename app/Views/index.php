                    ...
                    <?php foreach ($tickets as $ticket): ?>
                        ...
                        <td>
                            ...
                            <?php endif; ?>
                                ...
                                <a href="<?= base_url('/admin/tickets/'.$ticket->id) ?>" class="text" title="Ver"><?= esc($ticket->title) ?> (<?= esc($ticket->created_at); ?>)</a></p>
                            ...
                            <div class="d-grid gap-2 d-md-flex justify-content-md-end">
                                ...
                                <div class="">
                                <form class="" method="post" action="<?= base_url('/admin/tickets/'.$ticket->id)?>" id="ticketDeleteForm<?=$ticket->id?>">
                    ...
                    <!--
                        ...
                        <!-- <a href="<?= base_url('/admin/tickets/'.$ticket->id) ?>" class="btn btn-sm mx-1" title="Ver"><span class="fas fa-eye"><span></a> -->
                            ...
                            <form class="display-none" method="post" action="<?= base_url('/admin/tickets/'.$ticket->id)?>" id="ticketDeleteForm<?=$ticket->id?>">
                                    <input type="hidden" name="_method" value="DELETE"/>
                                    <a href="javascript:void(0)" onclick="deleteTicket('ticketDeleteForm<?=$ticket->id?>')" class="btn btn-sm text-danger" title="Eliminar registro"><span class="fas fa-trash"></span></a>
                                </form>
                        </td>
                    -->
                        </tr>
